...
_C: tuple[ConditionDef, ...] = (
    ...
    ConditionDef(
        ...
        "PDR-3, PDR-4 and RN to 24; Tualatin's Tables 40.220 and 41.220 "
        "let the quadplex row's 50 ft of lot WIDTH fall to 30 -- a different "
        "line, held on min_lot_width_ft. Answered by quadfit's s4 since "
