...
RUN_SCENARIO_TASK = "app.tasks.scenario.run_scenario"
FINALIZE_SCENARIO_TASK = "app.tasks.scenario.finalize_scenario"
...
@celery_app.task(bind=True, name="app.tasks.scenario.run_scenario")
def run_scenario(
    self,
    scenario_id: str,
...
@celery_app.task(bind=True, name="app.tasks.scenario.sweep_variable")
...
@celery_app.task(name="app.tasks.scenario.finalize_scenario")
