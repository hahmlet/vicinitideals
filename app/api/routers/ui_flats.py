...
_REASON_WORDS = {
    ...
    "ZONE_NOT_ENCODED": "a new zone code, under evaluation: nobody has ruled on it yet, so this lot is neither green nor red",
        ...
        cards.append(
            {
                ...
                "warns": refresh_service.warns(snap) if snap.status == "candidate" else [],
                ...
                "rerun": (
                    {
                        ...
                        "warns": refresh_service.warns(snap),
