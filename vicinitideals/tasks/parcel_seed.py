...
from vicinitideals.utils.priority import PriorityBucket, classify
...
@celery_app.task(name="vicinitideals.tasks.parcel_seed.seed_rlis_task", queue="default")
...
@celery_app.task(name="vicinitideals.tasks.parcel_seed.seed_parcels_task", queue="default")
...
@celery_app.task(name="vicinitideals.tasks.parcel_seed.classify_parcels_task", queue="default")
...
@celery_app.task(name="vicinitideals.tasks.parcel_seed.enrich_prime_target_parcels", queue="default")
...
@celery_app.task(name="vicinitideals.tasks.parcel_seed.rlis_quarterly_refresh_task", queue="default")
...
async def _purge_deleted_parcels(deleted_tlids: list[str]) -> int:
    ...
    from vicinitideals.models.parcel import ProjectParcel
