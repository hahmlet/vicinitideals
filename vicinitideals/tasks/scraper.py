...
from vicinitideals.models.ingestion import DedupStatus, IngestJob, SavedSearchCriteria
from vicinitideals.models.org import Organization
from vicinitideals.models.project import Opportunity, OpportunityStatus, OpportunitySource, ScrapedListing
from vicinitideals.models.property import Building, BuildingStatus, OpportunityBuilding
...
from vicinitideals.scrapers.dedup import deduplicate_batch
from vicinitideals.scrapers.realie import detect_address_issue
...
@celery_app.task(name="vicinitideals.tasks.scraper.scrape_listings")
def scrape_listings(
    source: str,
    search_params: dict,
...
@celery_app.task(
    name="vicinitideals.tasks.scraper.scrape_crexi",
    bind=True,
    max_retries=3,
)
def scrape_crexi(
...
@celery_app.task(
    name="vicinitideals.tasks.scraper.scrape_loopnet",
    bind=True,
    max_retries=3,
)
def scrape_loopnet(
