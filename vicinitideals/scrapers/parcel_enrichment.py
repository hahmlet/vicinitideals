...
from vicinitideals.schemas.parcel import (
    ClackamasParcelResult,
    OregonCityParcelResult,
    PortlandParcelResult,
)
from vicinitideals.utils.gis import detect_jurisdiction
...
async def _enrich_clackamas(address: str) -> dict[str, Any] | None:
    from vicinitideals.scrapers.clackamas import ClackamasLookupError, lookup_clackamas_parcel
...
async def _enrich_oregoncity(address: str) -> dict[str, Any] | None:
    from vicinitideals.scrapers.oregoncity import OregonCityLookupError, lookup_oregoncity_parcel
...
async def _enrich_portland(address: str) -> dict[str, Any] | None:
    from vicinitideals.scrapers.portlandmaps import PortlandMapsLookupError, lookup_portland_parcel
...
async def _upsert_parcel(session: Any, parcel_data: dict[str, Any]) -> Parcel:
    ...
    from vicinitideals.utils.priority import classify
