...
from vicinitideals.exporters import (
    DealImportResult,
...
from vicinitideals.models.deal import Deal, IncomeStream, OperatingExpenseLine, OperationalInputs, Scenario, UseLine
...
async def compute_model_cashflows(model_id: UUID, request: Request, session: DBSession) -> dict[str, Any]:
    ...
    try:
        from vicinitideals.api.routers.ui import _run_draw_schedule  # lazy to avoid circular import
