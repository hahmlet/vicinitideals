...
from vicinitideals.models.deal import Scenario as FinancialScenario  # financial plan
from vicinitideals.models.project import Opportunity, Project
from vicinitideals.models.scenario import (
    Sensitivity,
    SensitivityResult,
    SensitivityStatus,
)
from vicinitideals.observability import format_timestamp, log_observation, new_trace_id, utc_now
from vicinitideals.schemas.scenario import (
...
from vicinitideals.tasks.scenario import SCENARIO_VARIABLES, _dispatch_scenario_sweep, sweep_variable
