...
from vicinitideals.api.routers import ROUTERS
...
def create_app() -> FastAPI:
    ...
    from vicinitideals.api.routers.ui import router as ui_router
    app.include_router(ui_router)

    # Tools router — internal tooling pages (zone painter, etc.), no /api prefix
    from vicinitideals.api.routers.tools import router as tools_router
